    ...
    return (
        <div className="relative border border-[#1f1f1f] bg-[#0f0f0f] flex flex-col items-center justify-center gap-2 rounded-4xl py-4 px-5 pb-16">
            ...
            <div className="inline-flex items-center justify-center gap-0.5 text-sm">
                ...
                <div className="text-white text-sm !text-gray-700 font-semibold"><span className="text-white text-lg sm:text-xl">4</span>/5</div>
            </div>
            <div className="flex flex-col items-center justify-center gap-0.5">
                ...
                <p className="text-gray-400 text-sm text-center mt-2 line-clamp-4">{commentText}</p>
