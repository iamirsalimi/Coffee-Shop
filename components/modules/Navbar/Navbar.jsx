...
function Navbar({ setShowMenu , paddingFlag }) {
    ...
    return (
        <div className={`absolute ${paddingFlag ? 'px-5 xs:px-0 ' : 'px-6 '}xl:px-2 top-2 md:top-3 xl:top-0 left-1/2 -translate-x-1/2 flex flex-column md:flex-row items-center justify-between container z-20`}>
