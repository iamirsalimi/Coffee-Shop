...
function Footer() {
    return (
        <div className="bg-[#171717]">
            <div className="container mx-auto flex flex-col gap-2 divide-y divide-black">
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
                    {/* left side of the footer */}
                    <div className="lg:col-start-1 lg:col-end-4 flex flex-col gap-5 py-10">
                        {/* logo */}
                        <h1 className="text-center font-bold text-3xl xs:text-4xl sm:text-5xl lg:text-left md:text-[5rem] lg:text-[6rem] xl:text-[7rem] mb-5 text-white">COFFEE UNI</h1>
                        {/* links and address */}
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-7 px-5 xs:px-0">
                            <div className="flex flex-col items-center lg:items-start gap-2">
                                <h2 className="text-white font-bold font-sans text-lg xs:text-base">Navigation</h2>
                            ...
                            <div className="flex flex-col items-center lg:items-start gap-2">
                                <h2 className="text-white font-bold font-sans text-lg xs:text-base">Contact</h2>
                                <ul className="flex flex-col gap-1 items-center lg:items-start">
                            ...
                            <div className="flex flex-col items-center lg:items-start gap-3">
                                <h2 className="text-white font-bold font-sans text-lg xs:text-base">Address</h2>
                                <span className="text-gray-400 text-center lg:text-left">123 high street,cambridge,CB2 1TN, United Kingdom</span>
                            </div>
                        </div>
                    </div>
                    {/* right side of the footer */}
                    <div className="lg:col-start-4 lg:col-end-6 flex flex-col gap-5 place-content-center pb-5 sm:gap-7 px-5 xs:px-0">
